...
namespace Smallpt
{
    ...
    class Sphere
    {
        public readonly double rad;       // radius
        public readonly Vec p, e, c;      // position, emission, color
        public readonly Refl_t refl;      // reflection type (DIFFuse, SPECular, REFRactive)
        public readonly double maxC;
        public readonly Vec cc;
        private readonly double sqRad;
    ...
    class Smallpt
    {
        ...
        static Sphere[] spheres =
        {
			...
			new Sphere(16.5, new Vec(27,16.5,47),        Vec.Zero, new Vec(1,1,1)*.999,  Refl_t.SPEC),//Mirr
			new Sphere(16.5, new Vec(73,16.5,78),        Vec.Zero, new Vec(1,1,1)*.999,  Refl_t.REFR),//Glas
